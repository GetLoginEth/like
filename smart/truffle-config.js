...
/*const HDWalletProvider = require('truffle-hdwallet-provider');
const infuraKeyRinkeby = "357ce0ddb3ef426ba0bc727a3c64c873";
const fs = require('fs');
//const mnemonic = fs.readFileSync(".rinkeby").toString().trim();
...
module.exports = {
    ...
    networks: {
        ...
        /*rinkeby: {
            provider: () => new HDWalletProvider(privateKey, `https://rinkeby.infura.io/v3/${infuraKeyRinkeby}`),
